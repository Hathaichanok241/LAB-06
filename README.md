...
<![](https://github.com/Hathaichanok241/LAB-06/blob/master/imgs/6.2.JPG?raw=true)
 ...
 จะเกิด error ขึ้นเพราะ Console.Read() เป็นคำสั่ง จะเป็นสำหรับการรับค่าจากผู้ใช้งานที่เป็นตัวหนังสือ  ถ้าเราไม่ใส่ชนิดของข้อมูลที่เป็น string หรือ char  โปรแกรมจะเข้า
